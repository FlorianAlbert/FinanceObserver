...
public class RepositoryTests : IAsyncLifetime
{
    ...
    public async Task InsertAsync_CallWithNewEntities_AllCreatedDatesAreBetweenNowAndBeforeInserted()
    {
        ...
        // Assert
        entitiesToInsert.Should().AllSatisfy(insertedEntity => 
            insertedEntity.CreatedDate.Should().BeOnOrAfter(beforeInsert).And.BeOnOrBefore(afterInsert));
    }
    ...
    public async Task InsertAsync_CallWithNewEntities_AllUpdatedDatesAreEqualToCreated()
    {
        ...
        // Assert
        entitiesToInsert.Should().AllSatisfy(insertedEntity => insertedEntity.UpdatedDate.Should().Be(insertedEntity.CreatedDate));
    }
